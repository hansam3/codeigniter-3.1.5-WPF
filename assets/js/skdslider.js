...
(function($){
  ...
  $.skdslider.createNav=function(element,slides,config){
	    ...
	    if (config.showNextPrev==true){
			 var nextPrevButton ='<a class="prev"><img src="assets/images/main/issue_bt_left.png"></img></i></a>';
			     nextPrevButton +='<a class="next"><img src="assets/images/main/issue_bt_right.png"></img></a>';
